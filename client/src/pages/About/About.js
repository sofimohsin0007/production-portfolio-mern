        ...
        <div className="about" id="about">
          <div className="row">
            ...
            <div className="col-md-6 col-xl-6 col-lg-6 col-xs-12 about-content">
              <h1>About me</h1>
              <p>
                Hi, I'm a Fullstack Developer with a passion for creating
                dynamic and responsive web applications. I have experience in
                both frontend and backend technologies, and I'm always eager to
                learn new skills and improve my craft.
              </p>
              <p>
